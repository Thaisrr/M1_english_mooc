    ...
    recipes: [
        {
            ...
            intro:
                "For the main dish of our holiday menu, we will cook a low temperature egg and serve it with green lentils, gingerbread crumble and  alfalfa salad.",
            persons: 4,
            ...
            steps: [
                {
                    number: 1,
                    text:
                        "Peel the carrot, the onion and the celery stick, cut them roughly into pieces and put them into a sauce pan",
                },
                {
                    number: 2,
                    text:
                        "Cover with water, add salt and put the pan on high heat up to a boil. Then, reduce heat to medium and let cook for 20 minutes. ",
                },
                {
                    number: 3,
                    text:
                        "Take a large pan, pour glass of water into it. Take each egg and break them gently in the pan without piercing them. ",
                },
                {
                    number: 4,
                    text:
                        "Cover them with water and put the pan on low heat. Warm up the water up to 64°C, check regularly, and let it cook for 45 minutes. ",
                },
                {
                    number: 5,
                ...
                },
                {
                    number: 6,
                    text:
                        "Cut the gingerbread crust. Cut the butter into small dice, crumble the gingerbread and mix them together.",
                },
                {
                    number: 7,
                    text:
                        "Take a baking tray, put a sheet of baking paper and spread the mixture on it. Put the tray in the oven and cook it for 10 minutes. When it’s done, take it off the oven and let it rest for 10 minutes. ",
                },
                {
                    number: 8,
                ...
                },
                {
                    number: 9,
                    text:
                        "Put the alfalfa sprouts in a bowl, add 2 tablespoons of olive oil and one teaspoon of cider vinegar",
                },
                {
                    number: 10,
                    text:
                        "Take a plate, spread the lentils on it. Put the egg, the crumble, some alfalfa salad. Season the dish with some olive oil, salt and pepper. ",
                },
            ],
            transcription:
                "<p>For the main dish of our holiday menu, we will cook a low temperature egg and serve it with green lentils, gingerbread crumble and alfalfa salad.</p>\n" +
                ...
                "<p><br />Peel the red onion, take a&nbsp;board&nbsp;and chop it very finely.&nbsp;&nbsp;<br />Put the alfalfa sprouts in a bowl, add 2 tablespoons of olive oil and one teaspoon of cider vinegar. Take a plate, spread the lentils on it. Put the egg, the crumble, some alfalfa salad. Season the dish with some olive oil,&nbsp;salt&nbsp;and pepper.&nbsp;</p>",
        },
    ],
    quiz: [
        {
