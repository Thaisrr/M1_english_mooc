    ...
    recipes: [
        {
            ...
            steps: [
                {
                    number: 1,
                    text: "Bake the carrots, scrapped and sliced, with a drizzle of olive oil, for twenty minutes at 200°C "
                },
                {
                    number: 2,
                    text: "Let them cool down for twenty minutes. "
                },
                {
                    number: 3,
                    text: "Mix all the carrots, garlic, cumin seeds, almond paste, olive oil and lemon juice in the blender until smooth. "
                },
                {
                    number: 4,
        ...
        },
        {
            rank: 2,
            name: "Beetroots Dips",
            image: require('../images/beetroot.png'),
            intro: "This recipe is an easy one, but give really nice result with only a few ingredients. Let's try it !",
            persons: 4,
            video: "https://www.youtube.com/embed/0DTrTPtWoEQ",
            ingredients: [
                {
                    quantity: 1,
                    unity: "",
            ...
            steps: [
                {
                    number: 1,
                    text: "Cook the beetroot in a large pan of boiling water for about 40 minutes. Don’t cut or peel the beetroot, it will loose its beautiful purple color."
                },
                {
                    number: 2,
                    text: "Once the beet is soft, immerse it in cold water, to fixe the color, and let it chill."
                },
                {
                    number: 3,
                    text: "Meanwhile, cut the scallion into thin strips."
                },
                {
                    number: 4,
                    text: "When you’re beetroot has cooled down, peel it and cut it into large pieces."
                },
                {
                    number: 5,
                    text: "Then, pour the beet into a large bowl, and squash it with the cream cheese until you get a soft and uniform purple cream."
                },
                {
                    number: 6,
                    text: "Add the slices of scallions, some salt and pepper, and blend it."
                },
                {
                    number: 7,
                    text: "Your dip is now ready. Pour it into a nice bowl, and garnish with some walnut kernels. "
                },
                {
                    number: 8,
                    text: "Enjoy !"
        ...
        },
        {
            ...
            persons: 4,
            video: "https://www.youtube.com/embed/WSmKQUpPOds",
            ingredients: [
                {
                    quantity: 120,
                    unity: "g",
            ...
            steps: [
                {
                    number: 1,
                    text: "preheat the oven at 200°C "
                },
                {
                    number: 2,
                    text: "In a sip pan, stir the butter, the milk, the water, and the salt and bring to boil."
                },
                {
                    number: 3,
                    text: "Remove the pan from the stove, add the flour and stir until a smooth dough form. "
                },
                {
                    number: 4,
                    text: " Stir over low heat for about two minutes until the dough dries and pull away from the side of the pan "
                },
                {
                    number: 5,
                    text: "Let the dough cool for one minute and beat the eggs in it one by one (use an eggbeater if you have one)."
                },
                {
                    number: 6,
                    text: " Add the 40g of cheese, the pepper. "
                },
                {
                    number: 7,
                    text: "Transfer the dough in a pastry bag and pipe mounds the size of tablespoon on baking sheets 5 centimetres apart, and sprinkle with the remaining cheese. "
                },
                {
                    number: 9,
        ...
        },
        {
            ...
            persons: 4,
            video: "https://www.youtube.com/embed/11zBUHM00S0",
            ingredients: [
                {
                    quantity: 100,
                    unity: "g",
                ...
                },
                {
                    quantity: 120,
                    unity: "g",
                    name: "freshly grated Parmigiano"
                },
                {
                    quantity: 1,
                    unity: "",
            ...
            steps: [
                {
                    number: 1,
                    text: "Mix the flour, soft butter and Parmesan cheese in a bowl."
                },
                {
                    number: 2,
                    text: "Sand the dough by rubbing it between your hands. "
                },
                {
                    number: 3,
                    text: "When the dough is smooth, add the egg and incorporate it into the dough. Add a little flour if the dough is too sticky. "
                },
                {
                    number: 4,
                    text: "Form a ball, wrap in plastic film and leave to rest in the fridge for 1 hour. "
                },
                {
                    number: 5,
                ...
                {
                    number: 6,
                    text: "Roll out the dough to a thickness of 3mm and cut out the shortbread with a cookie cutter or a glass. "
                },
                {
                    number: 7,
                    text: "Place them on a baking tray covered with baking paper and bake for 10 to 15 minutes, keeping an eye on them. "
                },
                {
                    number: 8,
        ...
        },
        {
            ...
            steps: [
                {
                    number: 1,
                    text: "First, take the eggs and separate the whites from the yolks. We will need both so don’t discard the whites. Keep the yolks and put the whites in the fridge for later. "
                },
                {
                    number: 2,
                    text: "Put the yeast in a bowl and add 10cl of room temperature milk. If the milk is too cold you can warm it up beforehand by putting it in the microwave or in a saucepan for a few seconds, it will accelerate the activation of the yeast. Mix gently with a whisk. "
                },
                {
                    number: 3,
                    text: "Then, put the all-purpose flower and the buckwheat flour in a large mixing bowl, make a well in the middle and add the mixture of yeast and milk and the salt. Start whisking and add the rest of the milk little by little. Add the yolks and mix well. The batter must not have lumps. "
                },
                {
                    number: 4,
                    text: "Cover the mixing bowl with a clean dish towel and put it in a warm place. It can be by a window if the weather is sunny or if your oven has one, the fermentation mode would be perfect. Let it rise at least 2h00, the batter needs to double in size. "
                },
                {
                    number: 5,
                    text: "When the batter is almost done rising, take the whites from the fridge, put them in a large bowl with a pinch of salt and beat until stiff. At the end, your egg whites must form a stiff peak on the whisk. "
                },
                {
                    number: 6,
                    text: "Take the batter, add the whites in and gently mix them with a spatula. If you beat them, your batter will fall. "
                },
                {
                    number: 7,
                    text: "Put on frying pan on medium heat. When it’s hot, lightly grease the pan and drop one spoon fulls of batter and cook 1 minute on each side until golden. "
                },
                {
                    number: 8,
                    text: "You can maintain them hot in your oven at 50° or warm them up in a pan before serving. "
                },
            ],
            transcription: "<p>The preparation time is quite short, but you need to plan to let the batter rise for at least 2 hours before cooking. Let’s start. </p>" ,
        },
        {
            rank: 7,
            name: "Tiki Cocktail",
            ...
            persons: 1,
            video: "https://www.youtube.com/embed/to3W5Pm_jIU",
            ingredients: [
                {
                    quantity: 12,
                    unity: "cl",
            ...
            steps: [
                {
                    number: 1,
                    text: "Cut your passion fruit in half, then, with the help of a tablespoon, extract the fruit and put it into the blender,"
                },
                {
                    number: 2,
                    text: "Add the differents liquids, and the ginger and mix everything"
                },
                {
                    number: 3,
                    text: "Using a sieve to filter the crumbs, pour your cocktail into a glass,"
                },
                {
                    number: 4,
                    text: "Enjoy your coktail ( with moderation )"
                }
            ],
